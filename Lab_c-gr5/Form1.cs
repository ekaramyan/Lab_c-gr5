...
namespace Lab_c_gr5
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            string s = "Минимальный уровень заработной платы в стране за последние 8 лет";
            ...
            string[] year = new string[8] { "2009", "2010", "2011",
            "2012", "2013", "2014", "2015", "2016"};
            // Задаем значения элементов массива заработных плат
            int[] value = new int[8] { 525, 625, 884, 960, 1134, 1218, 1218, 1378 };
